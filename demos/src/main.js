...
$(function() {
	...
	// var canvas = new CanvasContext(200, 200);


	// var assets = new Assets(canvas);
	// var myimg = assets.load("myimg.png");

	// assets.addLoadable(function(finished) {
	// 	var image = new Image2D(256, 256);
	// 	image.
	...
	function render() {
		...
		//draw rectangles
		//	WebGL: 4x4 texture, tinted quad
		//	Canvas: fillRect
		//draw colored triangles
		//	WebGL: part of sprite batch, use 4x4 white texture
		//	Canvas: beginPath/endPath

		//extensible:
		//	procedural textures
		//	bloom filter / motion blur / etc
