...
var tintCanvas = require('./tint').tintCanvas;
var createTintedCanvas = require('./tint').createTintedCanvas;
var fastTint = require('./tint').fastTint;
...
var CanvasRenderer = new Class({
    ...
    setTint: function(r, g, b, a) {
        BaseRenderer.prototype.setTint.call(this, r, g, b, a);
        this.__updateColors(true, true);
    },
    ...
    drawImage: function(image, x, y, width, height) {
        ...
        if (this.tinting && image.tinting && (r !== 255 || g !== 255 || b !== 255)) {
            ...
            if (!this.tintCaching) {
                fastTint(ctx, src, this.__lastFillStyle, x, y, width, height);
                return;
            }
            ...
            src = image.tintCache.tinted( r, g, b );
        }
