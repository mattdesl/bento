...
var TintCache = new Class({
	...
	initialize: function(image) {
        ...
        this.fuzziness = image.tintCacheFuzziness;
        this.pointer = 0;

        this.__usePixelData = image.tintMode === Image2D.TintMode.BEST;
        this.__useMultiply = image.tintMode !== Image2D.TintMode.COLORIZE;
    ...
    tinted: function(r, g, b, fillStyle) {
        ...
        if (!ret) {
            ...
            if (usePixelData) {
                ...
                tint( this.__useMultiply, descriptor.context, src, fillStyle, 0, 0, width, height );
            }
